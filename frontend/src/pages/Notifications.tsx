...
export const Notifications = () => {
  ...
  if (isLoading) return <LoadingMessage message="Chargement des notifications..." />;
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <p className={`text-slate-900 ${!notification.readAt ? 'font-medium' : ''}`}>
                  ...
                  <div className="flex gap-3 mt-3">
                    {notification.type === 'share' && notification.shareId && !notification.readAt && (
                      <button
                        onClick={() => handleAcceptShare(notification._id, notification.shareId as string)}
